...
export const CollabDetailsTopHeaderContainer = styled(Box)({
  display: 'flex',
  justifyContent: 'space-between',
  alignItems: 'center',
});
export const LeftCollabDetailsContainer = styled(Box)({
  display: 'flex',
  justifyContent: 'center',
  alignItems: 'center',
  gap: '1rem',
...
export const InputBottomText = styled(Typography)(
  ({ variant, theme, showCursor }) => ({
    color:
      variant === 'error' ? theme.palette.red.main : theme.palette.grey.common,
